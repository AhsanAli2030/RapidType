...
Command: npx gltfjsx@6.2.16 keyboardist_robot.glb 
...
export default function Keyboard(props) {
  ...
  useEffect(() => {
    if (check === "SHOWANIMATIONS" || check === " JUMP_AND_KEYBOARD") {
          ...
          >
            <group name="Object_2">
              <group name="RootNode">
                <group
                  name="Mano-Der"
                  position={[-289.33, 924.547, 379.685]}
                  rotation={[2.115, 0, -Math.PI / 2]}
                  scale={[1, 0.951, 1]}
                >
                  <mesh
                ...
                <group
                  name="Mano-Izq"
                  position={[286.674, 931.263, 400.85]}
                  rotation={[2.114, 0, Math.PI / 2]}
                  scale={[1, 0.951, 1]}
                >
                  <mesh
                ...
                <group
                  name="Brazo-Izq"
                  position={[292.756, 1147.427, 188.406]}
                  rotation={[0.897, -Math.PI / 2, 0]}
                >
                  <mesh
                ...
                <group
                  name="Brazo-Der"
                  position={[-295.215, 1142.852, 179.99]}
                ...
                <group
                  name="Cabeza"
                  position={[-0.285, 1497.943, 157.885]}
                  rotation={[1.876, 0, 0]}
                >
                  <group
                    name="Cube"
                    position={[0.285, 160.174, 10.131]}
                    rotation={[-1.555, 0, 0]}
                  >
                    <mesh
                      name="Cube_Cristal_0"
                ...
                <group
                  name="Torso"
                  position={[1.611, 1027.041, 81.146]}
                  rotation={[1.709, 0, 0]}
                >
                  <mesh
                ...
                <group
                  name="Pierna-Izq"
                  position={[149.983, 603.79, 66.234]}
                  rotation={[1.476, 0, 0]}
                >
                  <mesh
                ...
                <group
                  name="Pie-Der"
                  position={[-149.431, 200.739, 77.134]}
                  rotation={[1.653, 0, 0]}
                >
                  <mesh
                ...
                <group
                  name="Pie-Izq"
                  position={[148.487, 197.712, 77.836]}
                  rotation={[1.653, 0, 0]}
                >
                  <mesh
...
useGLTF.preload("/keyboardist_robot.glb");
